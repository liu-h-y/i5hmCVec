...
def get_model(input_size):
    model = Sequential()
    model.add(Dense(1000, input_dim=input_size, activation='relu',kernel_regularizer=regularizers.l2(0.1)))
...
for random_state_num in range(10):
    ...
    for train_index, test_index in skf.split(X, y):
        ...
        clf.fit(X_train, y_train,epochs=epoch, batch_size=X_train.shape[0], verbose=1)
